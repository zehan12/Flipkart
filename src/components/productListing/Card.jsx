...
const Card = ({ product }) => {
    ...
    return (
        <Fragment>
            <div key={sku} className="overflow-hidden shadow-lg">
                <div style={{ float: "right" }} className="">
                    <MdFavorite color={"lightgray"} />
                </div>
                <div className="relative">
                    {Array(image.length)
                        ...
                        .map((_, i) => {
                            if (i === index) {
                                return show && <MdFiberManualRecord className="absolute bottom-0 right-0 mb-2 mr-2 text-gray-500" />;
                            } else {
                                return show && <MdFiberManualRecord className="absolute bottom-0 right-0 mb-2 mr-2 text-gray-500" />;
                            }
                        })}
